...
$destinatario = "contacto@airesyork.com";
...
$smtpHost = "mail.airesyork.com";  // Dominio alternativo brindado en el email de alta 
$smtpUsuario = "admin@airesyork.com";  // Mi cuenta de correo
$smtpClave = "AYork2018*/";  // Mi contrase�a
